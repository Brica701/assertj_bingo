...
public class BingoTest {
    ...
    public void testPonerBlancos() {
        int[][] carton = new int[9][3]; // Crear un cartón de 8 columnas y 3 filas

        // Ejecutar el método a probar
        Bingo.ponerBlancos(carton);

        // Contar el número de blancos en el cartón
        int blancosCount = 0;
    ...
    public void testBuscarValorRepetido() {
        ...
        // Verificar si el valor 3 está presente en el array
        assertTrue(Bingo.buscarValorRepetido(array, 3), "El valor 3 debería estar presente en el array");

        // Verificar si el valor 6 no está presente en el array
    ...
    public void testOrdenar() {
        ...
        // Verificar que el array está ordenado de menor a mayor
